...
class Game extends JPanel {
    ...
    private static Font FONT_M = new Font("Helvetica", Font.PLAIN, 24);
    private static Font FONT_M_ITALIC = new Font("Helvetica", Font.ITALIC, 24);
    private static Font FONT_L = new Font("Helvetica", Font.PLAIN, 74);
    private static Font FONT_XL = new Font("Helvetica", Font.PLAIN, 130);
    ...
    public Game() {
	        try {
	        	image = ImageIO.read(new File("gaas.png"));
				} catch (IOException e) {
	    ...
	    private void render(Graphics g) {
	        ...
	        g2d.setFont(FONT_M);
			        ...
			        if (status == GameStatus.NOT_STARTED) {
			        	drawCenteredString(g2d, "Grow Ga-as!", FONT_XL, 150);
			        	drawCenteredString(g2d, "by Redillas, Aranas, Calasang", FONT_M, 250);
			        	drawCenteredString(g2d, "Press any Key to Start", FONT_M_ITALIC, 290);  
			            return;
			        }
	        ...
	        g2d.drawString("BEST: " + String.format ("%02d", best), 630, 30);
			        ...
			        if (status == GameStatus.GAME_OVER) {
			            ...
			            drawCenteredString(g2d, "OH NO, GA-AS!", FONT_L, 300);
			        }
...
public class Main extends JFrame {
    ...
    private void initUI() {
        ...
        setTitle("'Grow Ga-as' by Redillas, Aranas, Calasang");
        setSize(800, 610);
